      ...
      <div className={"main-layout"}>
        ...
        <div className={"main-content bg-offwhite"}>
          <div className={"main-padding grid-vertical-gap-20px"}>
            <p className={"text-center"}>{ErrorConfig.en.error_404.message}</p>
            <Link href={ErrorConfig.en.error_404.direct.link} className={"text-center error-page-button"}>
              <span>{ErrorConfig.en.error_404.direct.text}</span>
              <PaperPlaneIcon
                height={20}
                width={20}
                colour={"#FFFFFF"}
